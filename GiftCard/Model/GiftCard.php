...
class GiftCard extends AbstractModel implements GiftCardInterface
{
    ...
    //    {
    //        $this->_getResource()->load($this, $code, self::CODE);
    //        return $this;
    //    }

    /**
     * Validate gift card before save
     *
     * @return $this
    ...
    //        if (!$this->getCode()) {
    //            throw new \Magento\Framework\Exception\LocalizedException(__('Gift card code is required'));
    //        }
    //
    //        if (!$this->getRecipientEmail()) {
    //            throw new \Magento\Framework\Exception\LocalizedException(__('Recipient email is required'));
    //        }
    //
    //        if (!$this->getRecipientName()) {
    //            throw new \Magento\Framework\Exception\LocalizedException(__('Recipient name is required'));
    //        }
    //
    ...
    //        }
    //
    //        // Ensure current_value matches initial_value for new cards
    //        if (!$this->getId() && $this->getInitialValue() && !$this->getCurrentValue()) {
